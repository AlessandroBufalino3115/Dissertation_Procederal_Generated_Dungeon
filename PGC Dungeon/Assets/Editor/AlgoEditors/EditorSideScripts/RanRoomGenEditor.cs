            ...
            case RanRoomGenMA.UI_STATE.CA:
                {
                    ...
                    else
                    {
                        ...
                        mainScript.allowedForward = true;
                        GeneralUtil.CellularAutomataEditorSection(mainScript.PcgManager, neighboursNeeded, out neighboursNeeded);
                    }
            ...
            case RanRoomGenMA.UI_STATE.ROOM_GEN:
                {
                    ...
                    else
                    {
                        ...
                        if (GeneralUtil.CalculateRoomsEditorSection(mainScript.PcgManager, minSize, out rooms, out minSize))
                        {
                            mainScript.allowedForward = true;
                        }
                            ...
                            if (GUILayout.Button("Connect all the rooms"))// dfor the corridor making
                            {
                                ...
                                switch (selGridPathGenType)
                                {
                                    case 0:   //A* pathfingin
                                        ...
                                        var path = AlgosUtils.A_StarPathfinding2D(mainScript.PcgManager.gridArray2D, new Vector2Int(tileA.x, tileA.y), new Vector2Int(tileB.x, tileB.y), !mainScript.PathType, useWeights: useWeights, arrWeights: mainScript.PcgManager.tileCosts);
