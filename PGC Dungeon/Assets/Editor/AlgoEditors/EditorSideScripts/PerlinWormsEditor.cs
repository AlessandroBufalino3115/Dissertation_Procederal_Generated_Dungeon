                ...
                case PerlinWormsMA.UI_STATE.WORM_CREATION:
                    {
                        ...
                        if (GUILayout.Button("Add one Worm"))
                        {
                            ...
                            var worm = DFAlgoBank.PerlinWorms(mainScript.pcgManager.gridArr, mainScript.scale, mainScript.octaves, mainScript.persistance, mainScript.lacunarity, mainScript.offsetX, mainScript.offsetY, length, turnMulti);
